    ...
    async def create_browser_context(self):
        ...
        try:
            ...
            if self.eval_mode:
                ...
                # Instead of connecting to an existing browser
                # browser = await PlaywrightManager._playwright.chromium.connect_over_cdp("http://localhost:9222")
                # PlaywrightManager._browser_context = browser.contexts[0]

                # Launch a new browser instance
                browser = await PlaywrightManager._playwright.chromium.launch(headless=False)
